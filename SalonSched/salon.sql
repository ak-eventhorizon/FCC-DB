--
-- Dump was maded by entering in a bash terminal:       pg_dump -cC --inserts -U freecodecamp salon > salon.sql
-- Database can be rebuilded from dump:                 psql -U postgres < salon.sql
--
